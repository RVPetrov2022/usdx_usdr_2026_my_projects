...
#define F_XTAL  25002000   // 25MHz SI5351 crystal  (enable for WB2CBA-uSDX, SI5351 break-out board or uSDXDuO)
...
#define MYCALL "My Name: USDX USDR.  Russia, Moscow , 3W, my blog: proftpd2000.livejournal.com"   // Что будем передавать в телеграфном режиме
#define MYNAME "GUIDO"
